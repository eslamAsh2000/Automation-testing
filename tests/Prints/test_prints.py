...
class Testprints():
    ...
    def test_prints(self, test_setup):
        driver.find_element_by_xpath("//a[contains(text(),'Prints')]").click()
        time.sleep(1)
        driver.find_element_by_xpath("//body/div[@id='root']/div[1]/div[1]/div[1]/nav[1]/div[1]/div[1]/ul[1]/li[3]/ul[1]/li[1]/a[1]").click()
        time.sleep(5)
